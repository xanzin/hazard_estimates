...
file1 <- nc_open ("surge-historical-PCT-prct90-v0.0.nc")                                          #
file2 <- nc_open ("surge-rcp45_end_century-PCT-prct90-v0.0.nc")                                   #
file3 <- nc_open ("surge-rcp85_mid_century-PCT-prct90-v0.0.nc")                                   #
                                                                                                  #
names(file1$var)                                                                                  #
names(file3$var)                                                                                  #
                                                                                                  #
...
variable.ref <- ncvar_get(file1, varid="surge_level_prct")
variable.future45 <- ncvar_get(file2, varid="surge_level_prct")
variable.future85 <- ncvar_get(file3, varid="surge_level_prct")
...
sigma.ref <- sd (variable.ref)
mu.ref <- variable.ref [position]
mu.fut <- variable.future45 [position]
